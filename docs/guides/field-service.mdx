...
For billing disputes handled by a back-office team (customer not physically present), an unlinked refund from the Cloud API is available on supported acquirers — see [Remote Sale & Refund guide](/reference/moto-guide) and the [Acquirer Capabilities Matrix](/reference/acquirer-capabilities-matrix).
