...
:::info
For the complete tip strategy reference — acquirer support, mutual exclusivity rules, and how to undo a tip adjustment — see the [Tipping Guide](/reference/tipping-guide).
:::
