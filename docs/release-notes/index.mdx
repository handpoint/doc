...
- **Deferred Card Tokenization**: new `deferredTokenization(originalTransactionID)` method tokenizes a card against a previously completed transaction without requiring the cardholder to present the card again.
