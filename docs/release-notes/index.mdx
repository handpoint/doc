...
- [`transactionRequest`](/reference/cloud-integration-guide) (card-present Sale / Keyed Entry) also accepts the same `billing` object for AVS on card-present transactions.
...
:::info Latest version
**7.1014.0** — requires a PAX debug device for unsigned APK development. See [Development hardware](/get-started/development-hardware).
:::
