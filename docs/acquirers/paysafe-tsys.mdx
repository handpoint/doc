...
6. **Requires merchant onboarding.** Paysafe tokenization must be activated for the merchant by Paysafe/Handpoint before use — contact your Handpoint integration engineer to provision this.
