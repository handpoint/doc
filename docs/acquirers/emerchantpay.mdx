...
<AcquirerPageHeader currentSlug="emerchantpay" />

**Geography:** Europe &nbsp;·&nbsp; **Cards:** <img src="/img/cards/visa.svg" alt="Visa" title="Visa" height="22" style={{verticalAlign:'middle',marginRight:'4px'}}/><img src="/img/cards/mastercard.svg" alt="Mastercard" title="Mastercard" height="22" style={{verticalAlign:'middle',marginRight:'4px'}}/><img src="/img/cards/amex.svg" alt="Amex" title="American Express" height="22" style={{verticalAlign:'middle',marginRight:'4px'}}/><img src="/img/cards/unionpay.svg" alt="UnionPay" title="UnionPay" height="22" style={{verticalAlign:'middle'}}/>

EmerchantPay is Handpoint's primary EU acquirer for card-present and card-not-present payments. It supports pre-authorization, Remote Sale (card token), tokenization, and money remittance. Typical users are EU-based ISVs serving retail and hospitality merchants who need a single acquirer across multiple European markets.
...
4. **Settlement is automatic.** EmerchantPay settles automatically — there is no manual batch close. The reversal window closes when the acquirer's automatic settlement runs.
