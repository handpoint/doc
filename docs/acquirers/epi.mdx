...
:::info
See [AVS for Keyed Entry and Remote Sale](/reference/avs-keyed-entry-remote-sale) for prerequisites and edge cases.
:::
...
:::info
See [AVS for Keyed Entry and Remote Sale](/reference/avs-keyed-entry-remote-sale) for prerequisites, field reference, and edge cases.
:::
...
EPI supports an optional `billing` object on MOTO Sale — postal code (and optionally street address) are forwarded to the acquirer to reduce CNP fraud risk. Requires `avsForMoto` enabled per merchant by Handpoint. See [AVS for Keyed Entry and Remote Sale](/reference/avs-keyed-entry-remote-sale) for prerequisites, field reference, and edge cases.
...
:::info
See [AVS for Keyed Entry and Remote Sale](/reference/avs-keyed-entry-remote-sale) for prerequisites, full field reference, and edge cases.
:::
