...
<FlavorSection description="Post-authorization · adjust tip before batch close" paths={["android-pax","android-hilite","cordova","backoffice"]}>
...
<FlavorSection description="EPI · proCharge vault — MOTO detokenization by gateway; ISV stays out of PCI scope" paths={["cloud-api","android-pax","android-hilite","ios-hilite","cordova","backoffice"]}>
