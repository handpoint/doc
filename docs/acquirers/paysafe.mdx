...
### Pre-Authorization {#pre-auth-create}

<FlavorSection paths={["cloud-api","android-pax","cordova","backoffice"]}>
...
<FlavorSection paths={["cloud-api","android-pax","android-hilite","ios-hilite","cordova"]}>
