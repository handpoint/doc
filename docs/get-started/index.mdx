...
| **Live / per-merchant** | Account Manager or Handpoint Onboarding Team — provisioned for each merchant when they go live |
...
Handpoint assigns a **dedicated Slack channel** to every ISV integration. The Integration Support team creates the channel, invites your team, and stays in it throughout the project. From that channel they:
...
Once your test app is validated, Handpoint issues a **certificate** documenting exactly what was tested and approved — a prerequisite for going live with merchants.

To start, reach out to your Account Manager or contact [support@handpoint.com](mailto:support@handpoint.com).
...
For supported features by acquirer, see the [EPI](/acquirers/epi), [PAYSAFE](/acquirers/paysafe), [EmerchantPay](/acquirers/emerchantpay), and [Paystrax](/acquirers/paystrax) acquirer pages. For a list of supported hardware, see [Supported Devices](/reference/devices).
...
[**Restaurant guide →**](/guides/restaurant-guide)
...
[**Practice Management guide →**](/guides/practice-management-guide)
...
**Best paths:** [Cloud API](#cloud-integration----rest-api) or [Android/iOS SDK (HiLite)](#bluetooth-integration----android--ios-sdk-hilite) with **Multi-MID + Tipping**

[**Salons & Spas guide →**](/guides/salons-guide)
...
[**Field service guide →**](/guides/field-service-guide)
...
[**Stadium & Events guide →**](/guides/events-guide)
...
|---|---|---|---|
| Restaurant (tableside) | Android SDK (PAX) | Pre-auth tabs, tip adjustment, batch close | [/guides/restaurant](/guides/restaurant-guide) |
| Restaurant (counter POS) | Cloud API | Same features, server-led | [/guides/restaurant](/guides/restaurant-guide) |
| Practice Management | Cloud API or Android PAX + Multi-MID | `externalId` routing, MOTO for phone payments | [/guides/practice-management](/guides/practice-management-guide) |
| Salons & Spas | Cloud API, Android/iOS HiLite + Multi-MID | Per-worker MIDs, on-device tipping, mobile reader | [/guides/salons](/guides/salons-guide) |
| Field service (mobile) | Android or iOS SDK (HiLite) | Bluetooth reader, transaction recovery | [/guides/field-service](/guides/field-service-guide) |
| Retail / Counter POS | Cloud API, JavaScript SDK, or Windows SDK | Standard sale/refund/reversal | [/reference/cloud-api-integration-guide](/reference/cloud-api-integration-guide) |
| Events / Stadium | Android SDK (PAX) | High-volume, Interac, multi-MID, UNDEFINED recovery, batch close | [/guides/events](/guides/events-guide) |
| Back office / MOTO | Cloud API back-office endpoints | No terminal needed | [/reference/backoffice-integration-guide](/reference/backoffice-integration-guide) |
...
**Full parameter tables with types, required/optional flags, and enum values:** [Cloud API — Operations Reference](/reference/cloud-api-operations#parameter-reference)
:::
