...
[**Restaurant guide →**](/guides/restaurant)
...
[**Clinic / Healthcare guide →**](/guides/clinic)
...
[**Field service guide →**](/guides/field-service)
...
[**Stadium & Events guide →**](/guides/events)
...
|---|---|---|---|
| Restaurant (tableside) | Android SDK (PAX) | Pre-auth tabs, tip adjustment, batch close | [/guides/restaurant](/guides/restaurant) |
| Restaurant (counter POS) | Cloud API | Same features, server-led | [/guides/restaurant](/guides/restaurant) |
| Clinic / Healthcare | Cloud API or Android PAX + Multi-MID | `externalId` routing, MOTO for phone payments | [/guides/clinic](/guides/clinic) |
| Field service (mobile) | Android or iOS SDK (HiLite) | Bluetooth reader, transaction recovery | [/guides/field-service](/guides/field-service) |
...
| Events / Stadium | Android SDK (PAX) | High-volume, Interac, multi-MID, UNDEFINED recovery, batch close | [/guides/events](/guides/events) |
