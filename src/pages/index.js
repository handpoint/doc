					...
					<div class="col col--6">
						<div class="handpointOptions">
							<div class="card-demo">
								<div class="card shadow--md">
									<div class="card__header" style={{ color: '#25365d'}}> 
										<b><h4>Transaction Analytics API</h4></b>
									</div>
									<div class="card__body" align="center">
										<div><img src="/img/feedapi.png" alt="Transaction Analytics API"></img></div>
										<a class="button button--primary indexButtons" href="https://txnfeedapi.handpoint.com/" ><b>Build in-depth transaction reporting for your software</b></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col col--6">
						<div class="handpointOptions">
							<div class="card-demo">
								<div class="card shadow--md">
									<div class="card__header" style={{ color: '#25365d'}}> 
										<b><h4>Merchants & Terminals Management API</h4></b>
									</div>
									<div class="card__body" align="center">
