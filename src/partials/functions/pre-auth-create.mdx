...
The Android SDK `preAuthorization()` accepts an optional `MerchantAuthOptions` (not plain `Options`) to override the merchant ID and terminal ID per acquirer. See [Multi-MID support](/reference/authentication#multi-mid) for details.
:::
