...
The Handpoint Android SDK is available on the Handpoint internal Nexus server. Nexus contains **development snapshots** of the SDK as well as the **production builds**.
