"use strict";
(globalThis["webpackChunkmy_website"] = globalThis["webpackChunkmy_website"] || []).push([[38844],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_javascript_versioned_docs_version_java_script_sdk_6_0_1_javascriptsandbox_md_de0_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/javascript/site-javascript-versioned-docs-version-java-script-sdk-6-0-1-javascriptsandbox-md-de0.json
const site_javascript_versioned_docs_version_java_script_sdk_6_0_1_javascriptsandbox_md_de0_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"javascriptsandbox","title":"Sandbox","description":"Get started today with our sandbox. You can generate sample transactions and test the experience right in your browser. Check it at//www.handpoint.com/lab/cloudpos. A payment terminal is required to start testing.","source":"@site/javascript_versioned_docs/version-JavaScript SDK 6.0.1/javascriptsandbox.md","sourceDirName":".","slug":"/javascriptsandbox","permalink":"/legacy/javascript/JavaScript SDK 6.0.1/javascriptsandbox","draft":false,"unlisted":false,"tags":[],"version":"JavaScript SDK 6.0.1","sidebarPosition":5,"frontMatter":{"sidebar_position":5,"id":"javascriptsandbox"},"sidebar":"tutorialSidebar","previous":{"title":"Configuration","permalink":"/legacy/javascript/JavaScript SDK 6.0.1/javascriptconfiguration"},"next":{"title":"Processing Payments Simulation","permalink":"/legacy/javascript/JavaScript SDK 6.0.1/javascriptprocessingpayments"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
;// ./javascript_versioned_docs/version-JavaScript SDK 6.0.1/javascriptsandbox.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["To get started, select the target environment where you are going to operate (Sandbox/Production). If the user has any doubts selecting the correct environment, click on  \"", (0,jsx_runtime.jsx)(_components.em, {
      ...
      }), "” and click the check button. This will automatically populate the “", (0,jsx_runtime.jsx)(_components.em, {
        children: "SELECT A DEVICE"
      }), "” drop down with the list of devices that are assigned to you. If the API key is not valid, an error message will appear in the “RESPONSES” section of the sandbox."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "Sandbox logo",
      ...
      children: ["Before you can begin any further testing, you first must select the device that you will be using. In the “", (0,jsx_runtime.jsx)(_components.em, {
        children: "SELECT A DEVICE"
      }), "” list, you will see both the real terminals assigned to you, as well as simulated devices (listed by serial number). You can choose any device to test with. Serial numbers for the simulated devices always have this format: XXXX | 999999xxxxx. Choose a simulated terminal if you do not have access to a real device or if you just want to see simulated behavior. You can refresh the “", (0,jsx_runtime.jsx)(_components.em, {
        children: "SELECT A DEVICE"
