...
We're excited to announce the latest update to our JavaScript SDK (Version 7.2.0), featuring comprehensive Money Remittance support to enhance your financial integration's capabilities. In order to use this functionality, we provide the integrator with an object called [Money Remittance Options](javascriptobjects.md#money-remittance-options)), which must be used in the operation.
...
To leverage the Money Remittance support in your integration, simply update your SDK to the latest version (7.2.0). Refer to the updated documentation for guidance on integrating and customizing the new features.
