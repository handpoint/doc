...
|`DuplicateCheck`<br />*String*|**String	DuplicateCheck is available for the following transactions:** Sale, Sale and Tokenize, Sale Reversal, Refund, Refund Reversal, MoTo Sale, MoTo Refund and MoTo Reversal.<br /> <br></br>The Duplicate Check service is enabled by default. If you want to disable it,  you must use the `String` "0" Example: ```options.Add(XmlTag.DuplicateCheck.Tag(), "0");```|
